// 학생 3명의 국어 영어 수학 점수 => 총점, 평균, 학점 출력
...
public class 자바제어문_반복문_9 {
	...
	public static void main(String[] args) {
		...
		// 지역변수는 => 메모리에서 관리 {}이 끝나면 자동으로 메모리에서 삭제
		// new => 프로그래머가 관리 => 자동으로 사라지지 않는다 => 계속 메모리에 존재
		// 메모리 누수현장 => GC(가비지 컬렉션 => 프로그램 종료 후 회수)
		...
		for(int i=0;i<3;i++) {
			...
			System.out.println((i+1)+"영어 점수:"+kor);
			System.out.println((i+1)+"수학 점수:"+kor);
