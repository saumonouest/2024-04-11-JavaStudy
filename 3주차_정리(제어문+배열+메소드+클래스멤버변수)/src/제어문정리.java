 ...
 * 			  --- ---- -----
 * 		   => 많은 경우 => 이름을 한 개로 압축
 * 			  --------------------------- 배열 / 클래스 - 가변적이다, 다른 데이터형을 모아서 관리(*****)
 * 										  ㄴ 고정적이다, 같은 데이터형만 모아서 관리
 * 		   => 1. 변수를 여러개
 * 		   => 2. 명령문 여러개
 * 			--------------- + 
 * 							 클래스 (한 개에 대한 기능)
 ...
 * 				false 일 때 처리
 * 			}
 * 			=> 서버프로그램 => 요청 받아서 처리 => 결과값을 보내준다
 * 							-----------------------------
 * 							로그인이 된 경우 => main 이동
 * 							로그인이 안 된 경우 ==> ID,PW 가 틀립니다
 * 							------------------------------------------
 * 
 * 		= 다중 조건문
 * 			경우의 수가 많은 경우
 ...
 * 
 * 	3. 반복 제어문 : 필요에 따라서 반복문을 종료 / 특정부분을 제어
 * 					=> break				=> continue
