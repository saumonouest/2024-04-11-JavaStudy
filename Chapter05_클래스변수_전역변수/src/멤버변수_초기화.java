...
public class 멤버변수_초기화 {
	...
	public static void main(String[] args) {
		...
		/*	m 이라는 공간 안에 1938개가 있는 거임
		 * => m.movies 라고 써야 접근 가능함
		 * 
		 */
		...
		System.out.println("출연한 영화 총"+count+"건");
		...
		System.out.println("검색한 장르"+count+"건");
