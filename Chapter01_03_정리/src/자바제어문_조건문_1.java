/*
 *	자바 조건문
 *	1. 단일 조건문 : 독립 문장 => 여러개 사용시에 조건에 맞는 모든 문장 수행
 *									   --------
 *		형식)
 *			if(조건문)
 *			{
 *				조건이 true 일 때 실행하는 문장
 *			}
...
public class 자바제어문_조건문_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1.콜라(1900) 2.파워에이드(2000) 3.커피(1200)");
		...
		if(menu==2)
		{
			System.out.println("파워에이드(2000) 선택하셨습니다");
			if(pay>=1500)
			{
				change=pay-1500;
			}
		...
		if(change>0)
		{
			...
			System.out.println("잔돈"+change%1000%500/100);
		}
