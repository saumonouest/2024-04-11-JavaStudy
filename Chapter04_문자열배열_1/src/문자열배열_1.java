 ...
 *  									 --------------- 메소드 
 *  String 사용법
 *  String name="ASS"; // 제한이 없다 => char[]을 클래스화
 *  -----------------
...
public class 문자열배열_1 {
	...
	public static void main(String[] args) {
		...
		String[] title={
			...
			// 노래 출력
			System.out.println("등록된 곡 총 "+title.length);
			int rank=1;
			for(String t:title) {
			...
			int count=0;
			for(String t:title) {
				if(t.contains(fd)) {// 제목 안에 단어가 포함되어있는지 여부 => 있으면 true / 없으면 false
			...
			System.out.println("=============================================");
			System.out.println("=================== 등폭출력 ===================");
			// 보통 배열이 여러개인 경우 => 인덱스 번호를 맞춘다
			// 상승 / 하락 / 유지
